...
var env_and_branch = {
  ...
  "primary_host": {
    "message": "Primary host in this stage for migrations & console (e.g. 'db1').\nRequired if using roles. Empty defaults to first host in list.",
    "allow_empty": true
  }
}
...
function build_stage(name, base_opts, callback) {
  ...
  if (base_opts) { // doing different stages
    var merged = merge(stage_deploy_to, env_and_branch, stage); 
