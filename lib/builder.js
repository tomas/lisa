...
var shared_paths = function(previous) {
  ...
  if (previous) { // requesting at role level
    ...
    // obj.depends_on = { keep_releases: { not: 0 } };
    obj.depends_on  = { no_releases: false };
    obj.allow_empty = true;
  }
...
var env_and_branch = function(stage_name) {
  return {
    ...
    "deploy_tag": {
      "message": "If true, will deploy the latest tagged ref. Good idea for production servers.",
      "default": false,
      "type"   : "boolean"
    },
    "branch": {
...
var app = {
  ...
  "keep_releases": {
    "message": "Releases to keep on servers, for rollback support.",
    "default": 3,
    "type": "number",
    "depends_on": {
      "no_releases": false
...
var stage_names = {
  ...
  "default_stage": {
    ...
    "default": function(answers) {
      return answers ? answers.stage_names.split(/,|\s/)[0] : null;
    }
  }
}
...
function build_stage(name, base_opts, different_stages, callback) {
  ...
  reply.get(opts, function(err, stage_opts) {
    ...
    if (stage_opts.deploy_tag === false)
      delete stage_opts.deploy_tag;
